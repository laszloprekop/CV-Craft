...
exports.DEFAULT_TEMPLATE_CONFIG = void 0;
 ...
 */
function createTemplateConfig(overrides) {
    if (!overrides) {
        return { ...exports.DEFAULT_TEMPLATE_CONFIG };
    }
    return {
        colors: { ...exports.DEFAULT_TEMPLATE_CONFIG.colors, ...overrides.colors },
        typography: { ...exports.DEFAULT_TEMPLATE_CONFIG.typography, ...overrides.typography },
        layout: { ...exports.DEFAULT_TEMPLATE_CONFIG.layout, ...overrides.layout },
        components: { ...exports.DEFAULT_TEMPLATE_CONFIG.components, ...overrides.components },
        pdf: { ...exports.DEFAULT_TEMPLATE_CONFIG.pdf, ...overrides.pdf },
        advanced: { ...exports.DEFAULT_TEMPLATE_CONFIG.advanced, ...overrides.advanced },
    };
}
/**
...
//# sourceMappingURL=defaultTemplateConfig.js.map
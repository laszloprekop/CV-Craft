...
export interface ColorFamily {
  name: string;
  shades: string[]; // 11 hex values: 50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 950
}

export const SHADE_LABELS = ['50', '100', '200', '300', '400', '500', '600', '700', '800', '900', '950'];
...
export const TAILWIND_COLORS: ColorFamily[] = [
  ...
  { name: 'indigo',  shades: ['#eef2ff','#e0e7ff','#c7d2fe','#a5b4fc','#818cf8','#6366f1','#4f46e5','#4338ca','#3730a3','#312e81','#1e1b4e'] },
